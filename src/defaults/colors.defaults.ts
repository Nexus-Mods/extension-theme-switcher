...
export const COLOR_DEFAULTS: IColorEntry[] = [
  ...
  // Statuses
  { name: 'danger', value: '#cc0000' },
  { name: 'danger-darker', value: '#a30000' },
  { name: 'danger-lighter', value: '#f50000' },
...
export const V1_TO_V2_MAP: V1TOV2MAP = {
  ...
  'danger': ['brand-danger', 0],
  'danger-darker': ['brand-danger', -0.22],
  'danger-lighter': ['brand-danger', 0.22],
